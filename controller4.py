...
class Tutorial (object):
    ...
    def __init__(self, connection):
        ...
        self.mac_to_port = {}
        self.arp_cache = {}
        self.interior = ["10.0.1.1", "10.0.1.2", "10.0.1.3", "10.0.1.4",  "10.0.2.1",
                         "10.0.2.2", "10.0.2.3", "10.0.2.4", "10.0.3.1", "10.0.3.2", "10.0.3.3", "10.0.3.4"]
        self.exterior = ["10.0.1.1", "10.0.2.1", "10.0.3.1"]

        self.dirconnex = {1: ["10.0.1.2", "10.0.1.3", "10.0.1.4", "10.0.2.1", "10.0.3.1"], 2: [
            "10.0.2.2", "10.0.2.3", "10.0.2.4", "10.0.1.1", "10.0.3.1"], 3: ["10.0.3.2", "10.0.3.3", "10.0.3.4", "10.0.1.1", "10.0.2.1"]}
        self.routing_table = dict()
        self.routing_table[1] = {'10.0.1.2': ['10.0.1.2', 's1-eth1', '10.0.1.1', 1], '10.0.1.3': ['10.0.1.3', 's1-eth2', '10.0.1.1', 2], '10.0.1.4': ['10.0.1.4', 's1-eth3', '10.0.1.1', 3], '10.0.2.1': ['10.0.2.1', 's1-eth4', '10.0.1.1', 4], '10.0.2.2': ['10.0.2.1', 's1-eth4', '10.0.1.1', 4],  '10.0.2.3': [
            '10.0.2.1', 's1-eth4', '10.0.1.1', 4], '10.0.2.4': ['10.0.2.1', 's1-eth4', '10.0.1.1', 4], '10.0.3.1': ['10.0.3.1', 's1-eth5', '10.0.1.1', 5], '10.0.3.2': ['10.0.3.1', 's1-eth5', '10.0.1.1', 5],  '10.0.3.3': ['10.0.3.1', 's1-eth5', '10.0.1.1', 5], '10.0.3.4': ['10.0.3.1', 's1-eth5', '10.0.1.1', 5]}
        self.routing_table[2] = {'10.0.2.2': ['10.0.2.2', 's2-eth1', '10.0.2.1', 1], '10.0.2.3': ['10.0.2.3', 's2-eth2', '10.0.2.1', 2], '10.0.2.4': ['10.0.2.4', 's2-eth3', '10.0.2.1', 3], '10.0.1.1': ['10.0.1.1', 's2-eth4', '10.0.2.1', 4], '10.0.1.2': ['10.0.1.1', 's2-eth4', '10.0.2.1', 4],  '10.0.1.3': [
            '10.0.1.1', 's2-eth4', '10.0.2.1', 4], '10.0.1.4': ['10.0.1.1', 's2-eth4', '10.0.2.1', 4], '10.0.3.1': ['10.0.3.1', 's2-eth5', '10.0.2.1', 5], '10.0.3.2': ['10.0.3.1', 's2-eth5', '10.0.2.1', 5],  '10.0.3.3': ['10.0.3.1', 's2-eth5', '10.0.2.1', 5], '10.0.3.4': ['10.0.3.1', 's2-eth5', '10.0.2.1', 5]}
        self.routing_table[3] = {'10.0.3.2': ['10.0.3.2', 's3-eth1', '10.0.3.1', 1], '10.0.3.3': ['10.0.3.3', 's3-eth2', '10.0.3.1', 2], '10.0.3.4': ['10.0.3.4', 's3-eth3', '10.0.3.1', 3], '10.0.2.1': ['10.0.2.1', 's3-eth4', '10.0.3.1', 4], '10.0.2.2': ['10.0.2.1', 's3-eth4', '10.0.3.1', 4],  '10.0.2.3': [
            '10.0.2.1', 's3-eth4', '10.0.3.1', 4], '10.0.2.4': ['10.0.2.1', 's3-eth4', '10.0.3.1', 4], '10.0.1.1': ['10.0.1.1', 's3-eth5', '10.0.3.1', 5], '10.0.1.2': ['10.0.1.1', 's3-eth5', '10.0.3.1', 5],  '10.0.1.3': ['10.0.1.1', 's3-eth5', '10.0.3.1', 5], '10.0.1.4': ['10.0.1.1', 's3-eth5', '10.0.3.1', 5]}
        self.store = None
